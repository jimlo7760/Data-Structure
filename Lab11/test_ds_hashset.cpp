...
int main() {
    ...
    ds_hashset<std::string, bad_hash_string_obj> b;
    b.insert(std::string("bbb"));
    b.insert(std::string("bab"));
    b.insert(std::string("bba"));
    b.print(std::cout );
    std::cout << "===========" << std::endl;

    ds_hashset<std::string , anagram_hash_string_obj> c;
    c.insert(std::string("god"));
    c.insert(std::string("dog"));
    c.print(std::cout);
    std::cout << "===========" << std::endl;
