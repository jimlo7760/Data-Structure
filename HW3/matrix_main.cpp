...
void StudentTest(){
    std::cout << "Student test start: " << std::endl;
    Matrix m12 = Matrix(10, 10, 9.9);
    std::cout << "Before multiplication: " << std::endl;
    std::cout << m12 << std::endl;
    m12.multiply_by_coefficient(5);
    std::cout << "After multiplication: " << std::endl;
    std::cout << m12 << std::endl;
    Matrix m13 = Matrix(10, 9, 5);
    std::cout << "Before transpose: " << std::endl;
    std::cout << m13 << std::endl;
    m13.transpose();
    std::cout << "After transpose: " << std::endl;
    std::cout << m13 << std::endl;
    Matrix m14 = Matrix(10, 10, 10);
    std::cout << "Before subtract: (for each position subtract 10) " << std::endl;
    ...
    double* m14Col5 = NULL;
    m14Col5 = m14.get_col(4);
    for (double* i = m14Col5; i < m14Col5 + m14.num_rows(); i++){
        std::cout << *i;
    }
    delete [] m14Col5;
}
...
void ExtraCreditTest(){
    Matrix m15 = Matrix(10, 10, 1);
    std::cout << "Before resize: (shrink row & column) " << std::endl;
    std::cout << m15 << std::endl;
    m15.resize(5, 5, 1);
    std::cout << "After resize: " << std::endl;
    std::cout << m15 << std::endl;
    Matrix m16 = Matrix(10, 10, 1);
    std::cout << "Before resize: (shrink row, enlarge column) " << std::endl;
    std::cout << m16 << std::endl;
    m16.resize(5, 15, 10);
    std::cout << "After resize: " << std::endl;
    std::cout << m16 << std::endl;
    Matrix m17 = Matrix(10, 10, 1);
    std::cout << "Before resize: (enlarge row, shrink column) " << std::endl;
    std::cout << m17 << std::endl;
    m17.resize(15, 5, 10);
    std::cout << "After resize: " << std::endl;
    std::cout << m17 << std::endl;
    Matrix m18 = Matrix(10, 10, 1);
    std::cout << "Before resize: (enlarge row, shrink column) " << std::endl;
